        ...
        if (data[0] == "START"):
            ...
            for i in range(self._board_size):
                for j in range(self._board_size):
                    ...
                    ## Our dictionary with key as the location of move e.g. (0, 0) and value as the weight
                    ## currently the weight is random 
    ...
    def _wait_message(self):
        ...
        if (data[0] == "END" or data[-1] == "END"):
            ...
            if (data[1] == "SWAP"):
                ...
                ## removing moves which have been taken in order to stop 
                self._choices_dict.pop((int(x), int(y)))
